...
train_envs = ts.env.SubprocVectorEnv([lambda: gym.make('numberx-serengeti-v0') for _ in range(16)])
test_envs = ts.env.SubprocVectorEnv([lambda: gym.make('numberx-serengeti-v0') for _ in range(64)])
