...
train_envs = ts.env.DummyVectorEnv([lambda: gym.make('numberx-serengeti-v0') for _ in range(16)])
test_envs = ts.env.DummyVectorEnv([lambda: gym.make('numberx-serengeti-v0') for _ in range(64)])
